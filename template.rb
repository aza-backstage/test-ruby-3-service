...
say <<~INFO
  ...
  name: test-ruby-3
  kebabCase: test-ruby-3
  pascalCase: TestRuby3
  camelCase: testRuby3
  snakeCase: test_ruby_3
  pascalKebabCase: Test-Ruby-3
  repoOwner: aza-backstage
  api: true
  active_job: false
  asset_pipeline: none
  javascript: none
...
say_status :harness, "Check if harness should be included. (Harness - true)"
if "true".casecmp("true").zero?
...
if "aza-backstage".match?(/^bitpesa$/)
