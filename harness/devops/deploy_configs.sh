...
echo "Deploying configs to harness-test-ruby-3-service service $environment environment"
echo "============================================"

kubectl create configmap harness-test-ruby-3-service-configs --from-env-file configs/harness-test-ruby-3-service-$environment -o yaml --dry-run | kubectl apply --namespace harness -f -
rm -rf configs/harness-test-ruby-3-service-$environment
