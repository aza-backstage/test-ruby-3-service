...
echo "Deploying harness-test-ruby-3-service service to the $ENVIRONMENT_NAME environment"
...
echo "Deployed: harness-test-ruby-3-service to the $ENVIRONMENT_NAME"
echo "Version: $TAG "
echo "============================================"
