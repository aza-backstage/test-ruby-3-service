...
echo "Deploying configs to test-ruby-3-service $environment environment"
echo "============================================"

kubectl create configmap test-ruby-3-service-configs --from-env-file configs/test-ruby-3-service-$environment -o yaml --dry-run | kubectl apply --namespace test-ruby-3-service -f -
rm -rf configs/test-ruby-3-service-$environment
